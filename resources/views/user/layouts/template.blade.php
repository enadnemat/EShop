...
<head>
    ...
    <link rel="icon" href="../../../../public/user_assets/img/fevicon.png" type="image/png"/>
    <title>EShop</title>
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" type="text/css" href="{{asset('user_assets/css/bootstrap.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('user_assets/vendors/linericon/style.css')}}"/>
    <link rel="stylesheet" type="text/css" href="{{asset('user_assets/css/font-awesome.min.css')}}"/>
    <link rel="stylesheet" type="text/css" href="{{asset('user_assets/css/themify-icons.css')}}"/>
    <link rel="stylesheet" type="text/css" href="{{asset('user_assets/vendors/owl-carousel/owl.carousel.min.css')}}"/>
    <link rel="stylesheet" type="text/css" href="{{asset('user_assets/vendors/lightbox/simpleLightbox.css')}}"/>
    <link rel="stylesheet" type="text/css" href="{{asset('user_assets/vendors/nice-select/css/nice-select.css')}}"/>
    <link rel="stylesheet" type="text/css" href="{{asset('user_assets/vendors/animate-css/animate.css')}}"/>
    <link rel="stylesheet" type="text/css" href="{{asset('user_assets/vendors/jquery-ui/jquery-ui.css')}}"/>
    <!-- main css -->
        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light w-100">
                ...
                <a class="navbar-brand logo_h" href="{{route('user.index')}}">
                    <img src="{{asset('user_assets/img/logo.png')}}"/>
                </a>
                        ...
                        <div class="col-lg-5 pr-0">
                            <ul class="nav navbar-nav navbar-right right_nav pull-right">
                                @if(Auth::user())
                                    ...
                                    <li class="nav-item">
                                        <a href="{{route('view.cart',Auth::user()->id )}}" class="icons">
...
{{--<script src="public/user_assets/vendors/risotope/imagesloaded.pkgd.min.js"></script>--}}
