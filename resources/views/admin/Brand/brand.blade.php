    ...
    <div class="row">
        <div class="col-md-6 col-sm-12 ">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <form method="post" action="{{route('store.brand')}}" id="submitForm" class="submitForm">
                        @csrf
                        <div class="form-group row">
                            <label class="col-sm-6 col-form-label">Brand name (In english)</label>
                            <div class="col-sm-12">
                                <div class="input-group">
                                    <input type="text" id="en_name" name="en_name" required class="form-control">
                                </div>
                            </div>
                            <label class="col-sm-6 col-form-label">Brand name (In arabic)</label>
                            <div class="col-sm-12">
                                <div class="input-group">
            ...
            submitHandler: function (form) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        location.href = "{{Route('add.brands')}}";
                    },
